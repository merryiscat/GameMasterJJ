...
async def search_test(
    ...
    if q.strip():
        try:
            from web.admin.search_service import search_chromadb, get_playbook
            ...
            # 전체 청크 수
            from web.admin.search_service import get_collection_count
